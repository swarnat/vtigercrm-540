...
class ListViewController {
    ...
    /** Add by swarnat (Search in reference fields) START */
    ...
    /** Add by swarnat (Search in reference fields) END */
	...
	public function getAdvancedSearchOptionString() {
        ...
        foreach($references as $reference) {
            ...
            foreach ($moduleFields as $fieldName=>$field) {
                ...
                $fieldLabelEscaped = str_replace(" ","_",$field->getFieldLabelKey());
                $optionvalue = $field->getTableName().":".$field->getColumnName().":".$fieldName.":".$module."_".$fieldLabelEscaped.":".$typeOfData."->".$reference->getFieldName().":".$module;

                $OPTION_SET[getTranslatedString($reference->getFieldLabelKey(), $module).": ".$blockName][$label] = "<option value=\'$optionvalue\' $selected>$label</option>";
